...
func (g *Gradient) Tick(connecting, playing bool) {
	var base float64
	switch {
	case connecting:
		base = 1.4
...
// buildPalette creates a round-trip lightness palette from the detected fg color.
func buildPalette(base colorful.Color, n int) []lipgloss.Color {
	...
	// Round-trip: reverse without repeating endpoints
